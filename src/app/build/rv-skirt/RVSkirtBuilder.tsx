          ...
          <div>
            ...
            <div className="mt-6 bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
              ...
              <button
                ...
                className="mt-4 w-full sm:w-auto inline-flex items-center justify-center px-8 py-3 bg-brand-500 text-dark-900 font-semibold rounded-lg hover:bg-brand-400 transition-colors cursor-pointer"
              >
                Add to Cart
              </button>
            </div>
